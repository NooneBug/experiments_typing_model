...
model_path = 'checkpoints/TL_into_Ontonotes/BF_FIGER/model_1.ckpt'
dataloader_path = 'dataloaders/Bert_Baseline_ontonotes_dev.pkl'
...
metrics_file = 'result_logs/quality_prediction/TL_into_Ontonotes/sota_BF_FIGER.txt'
