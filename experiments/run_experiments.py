...
exp_list = [
            ...
            } for name in ['B_FIGERIntoBalancedOntonotes0', 'BF_FIGERIntoBalancedOntonotes0',
                            'B_FIGERIntoBalancedOntonotes1', 'BF_FIGERIntoBalancedOntonotes0',
                            'B_FIGERIntoBalancedOntonotes2', 'BF_FIGERIntoBalancedOntonotes0']     
        ]
